...
class _DailyActivityState extends State<DailyActivity> {
  ...
  Future<Map> _getData(String TglAwal, String TglAkhir) async {
    ...
    return Mod_DailyActivity(this.widget.sess, Parameter: oParam()).Read();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: Theme.of(context).primaryColor,
        onPressed: () async{
          await Navigator.push(context,MaterialPageRoute(builder: (context) => InputDailyActivity(this.widget.sess!))).then((value) {
            _fetchData(_formatedTglAwal,_formatedTglAkhir);
          });
        },
      ),
                    ...
                    itemBuilder: (context, index) {
                      return Card(
                        child: ListTile(
                          ...
                          onTap: () async{
                            await Navigator.push(context,MaterialPageRoute(builder: (context) => InputDailyActivity(this.widget.sess, iddata: int.parse(_dateGuestLog![index]["id"]),))).then((value) {
                              _fetchData(_formatedTglAwal,_formatedTglAkhir);
                            });
                          },
                        ),
